...
from src.ultrazoom.v2.model import UltraZoom
...
def main():
    ...
    parser.add_argument("--noise_amount", default=0.2, type=float)
    ...
    parser.add_argument("--num_channels", default=24, type=int)
